...
public class StudentRepository implements CrudRepository<Student>{
    ...
    static final String QUERY_CREDITS = "SELECT SUM(credits) AS 'TOTAL' FROM STUDENT " +
            ...
            "INNER JOIN KURS ON KURS.kursID = ENROLLED.kursID " +
    ...
    public Student getOne(long id) throws SQLException {
        ...
        while (resultSet.next()){
            student = new Student(new Person(resultSet.getLong("personID"), resultSet.getString("firstName"), resultSet.getString("lastName")), resultSet.getLong("studentID"));
        }
    ...
    public void delete(Student obj) throws SQLException {
        ...
        preparedStatement.setLong(1, obj.getStudentID());
    ...
    public Student update(Student obj) throws SQLException {
        ...
        preparedStatement.setLong(1, obj.getPersonID());
        preparedStatement.setInt(2, obj.getTotalCredits());
        preparedStatement.setLong(3, obj.getStudentID());
    ...
    public int credits(Student obj) throws SQLException{
    ...
    public List<Long> enrolledCourses(Student obj) throws SQLException{
